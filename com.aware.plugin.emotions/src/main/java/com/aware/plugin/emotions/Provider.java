...
public class Provider extends ContentProvider {
    ...
    public static String AUTHORITY = "com.aware.plugin.emotions.provider.xxx"; //change to package.provider.your_plugin_name
    ...
    public static final class TableOne_Data implements AWAREColumns {
        ...
        public static final String CONTENT_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/vnd.com.aware.plugin.emotions.provider.table_one"; //modify me
        public static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/vnd.com.aware.plugin.emotions.provider.table_one"; //modify me
